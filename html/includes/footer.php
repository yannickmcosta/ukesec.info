<footer class="pt-4 my-md-2 pt-md-4 border-top">
	<div class="row">
		<div class="col-md-6">
			<p>
				<a href="https://mccabecosta.com"><i class="fas fa-fw fa-code" alt="Coded"></i> with <i class="fas fa-fw fa-heart text-danger" alt="love"></i> by yannick@mccabecosta.com</a><br />
			</p>
		</div>
